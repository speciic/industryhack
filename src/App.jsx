        ...
        <div className="container">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="section-tag mx-auto">
              ...
              <span>Core Track Domains</span>
            </div>
            <h2 className="section-title">Technical Domains &amp; Challenges</h2>
            <p className="section-subtitle mx-auto">
              Select your domain of expertise and apply your problem-solving capabilities to solve challenges crafted for engineering impact.
            </p>
          </div>
